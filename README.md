...
&nbsp;&nbsp;수도권의 전력 수급이 불균형인 이유는, 수도권에 주로 기업체들이 입주해있기 때문이다. 기업체가 입주해있기 때문에 수도권에 다시 사람들이 몰리고, 인프라가 수도권 위주로만 발전하는 악순환이 도는 것이다. 이러한 작금의 상황이 비용적인 측면에서 손실을 유발하고 있다는 것을, 실증하고자 해당 연구를 진행한 것이다.
